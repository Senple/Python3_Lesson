# -*- coding: utf-8 -*-
# Sample cord:https://qiita.com/mas9612/items/a881e9f14d20ee1c0703
...
with closing(sqlite3.connect(dbname)) as conn:
    #databeseに接続している
    c = conn.cursor()
    #cursor()オブジェクトでデータベース制御できるコマンドを実行可能
    ...
    # タプルで渡す．
    '''c.executeが(create_table)がエラーになるとき
    →sqlite3.OperationalError: table users already exists
    にはデータベースの中身をすべて削除するとうまくいく'''
